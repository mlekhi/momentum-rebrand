    ...
    <footer className="px-6 py-4 flex flex-col gap-6">
      <div className="flex justify-between items-start">
        <div className="flex flex-col gap-1">
          <a href="https://lu.ma/moment.um?utm_source=momentum_website" target="_blank" rel="noopener noreferrer" className="text-sm font-bold uppercase hover:opacity-70 transition-opacity">join us</a>
          <a href="https://buymeacoffee.com/moment.um" target="_blank" rel="noopener noreferrer" className="text-sm font-bold uppercase hover:opacity-70 transition-opacity">contribute</a>
          <a href="/timer" className="text-sm font-bold uppercase hover:opacity-70 transition-opacity">live timer</a>
        </div>
